...
(
    ...
    relatedEntityId    BIGINT COMMENT '关联的实体 ID，根据 user_type 确定关联的表：corporate 对应 corporate_client 表，individual 对应 individual_client 表，lawyer 对应 lawyer 表，admin 对应 administrator 表',
...
CREATE INDEX idx_corporate_client_insertTimeForHis ON corporate_client (insertTimeForHis);
CREATE INDEX idx_corporate_client_operateTimeForHis ON corporate_client (operateTimeForHis);
...
CREATE INDEX idx_individual_client_insertTimeForHis ON individual_client (insertTimeForHis);
CREATE INDEX idx_individual_client_operateTimeForHis ON individual_client (operateTimeForHis);
