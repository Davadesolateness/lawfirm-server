...
-- 若需删除 corporate_client 表，可取消此注释
...
CREATE INDEX idx_corporate_client_insert_time_for_his ON corporate_client (insert_time_for_his);
CREATE INDEX idx_corporate_client_operate_time_for_his ON corporate_client (operate_time_for_his);

-- 若需删除 individual_client 表，可取消此注释
...
CREATE INDEX idx_individual_client_insert_time_for_his ON individual_client (insert_time_for_his);
CREATE INDEX idx_individual_client_operate_time_for_his ON individual_client (operate_time_for_his);
...
CREATE INDEX idx_administrator_parent_admin_id ON administrator (parent_admin_id);
CREATE INDEX idx_administrator_insert_time_for_his ON administrator (insert_time_for_his);
CREATE INDEX idx_administrator_operate_time_for_his ON administrator (operate_time_for_his);