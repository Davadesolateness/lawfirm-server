 ...
 * @package: com.lawfirm.lawfirmserver.lawyer.vo
 * @className: ConsultationReplyVo
 * @author: Eric
 * @description: 律师回复咨询请求VO
 * @date: 2025/6/22 15:39
 * @version: 1.0
 */
@Data
@ApiModel("律师回复咨询请求")
public class ConsultationReplyVo implements Serializable {
    ...
    @ApiModelProperty(value = "回复内容", required = true, example = "根据您的描述，这种情况属于合同违约...")
